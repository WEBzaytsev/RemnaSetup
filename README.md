...
- Вариант 1
```bash
bash <(curl -fsSL https://cdn.jsdelivr.net/gh/WEBzaytsev/RemnaSetup@main/install.sh)
```
- Вариант 2
```bash
curl -fsSL https://cdn.jsdelivr.net/gh/WEBzaytsev/RemnaSetup@main/install.sh -o install.sh && chmod +x install.sh && sudo bash ./install.sh
```
